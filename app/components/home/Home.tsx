    ...
    <section id="home">
        <div className='p-10 md:pt-20'>
            <div className='flex flex-col justify-center'>
                ...
                <h2 className='text-lg/7 md:text-2xl/10 text-center md:pl-32 md:pr-32 lg:pl-72 lg:pr-72 mb-14'>Computer engineer graduated from the University of Guadalajara. I am a web developer building the frontend and backend of websites and web applications</h2>
